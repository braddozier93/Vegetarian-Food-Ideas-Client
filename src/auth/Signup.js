        ...
        <div>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <FormGroup>
                    ...
                    <Input onChange={(e) => setUsername(e.target.value)} name="username" pattern="(?=.*[!@#$%^&*])(?=.*[a-z]).{4,}" placeholder="4 or More Characters & Must Include A Special Character"value={username} />
                </FormGroup>
                <FormGroup>
